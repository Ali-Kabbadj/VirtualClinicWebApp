...
namespace VirtualClinic.ViewModels
{
    public class RegisterViewModel
    {
        ...
        [Required(ErrorMessage = "The IdCard Filed is required")]
        ...
        [Required]
        [EmailAddress]
        [Remote("EmailDoesNotExist", "Account",ErrorMessage="This Email is already in use")]
        [Display(Name = "Email")]
        [PersonalData]
        ...
        [Required]
        [Remote("PhoneExists", "Account", ErrorMessage = "The Phone Number already in use")]
        [PersonalData]
